    ...
    request
      .then((data) => {
        ...
        if (
          ...
          data.packageDetailReviewDtoResponses.content
        ) {
          setReviews(data.packageDetailReviewDtoResponses.content); // Set reviews data
        }
        if (data.serviceDtoResponses && data.serviceDtoResponses.content) {
          setServices(data.serviceDtoResponses.content); // Set services data
          // Flatten service images and set them
          const serviceImages = data.serviceDtoResponses.content.flatMap(
                  ...
                  {images?.map((image) => {
                    ...
                    >
                      <button
                        ...
                        onClick={
                          image
                            ? onChangeImageHandler.bind(null, image.url)
                            : null
                        }>
                        <img
                          src={image?.url}
          ...
          <div className="row mb-120">
            <div className="col-lg-12">
              <div className="nav nav2 nav  nav-pills">
                ...
                <button
                  className={`nav-link ${review ? "active" : ""}`}
              ...
              {description && (
                <ServicePackageDescription content={descriptions} />
              )}
              {review && (
                                    ...
                                    <div className="review-content">
                                      <div className="c-header d-flex align-items-center">
                                        <div className="review-meta">
                                          <h5 className="mb-0">
                                            <a href="#">
                                              {review.userDtoResponse.fullName}
                                            </a>
                                          </h5>
